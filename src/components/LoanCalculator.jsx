      ...
      <div className="calculator-on-mobile">
        {!showResults ? (
          <div className="calculator-content">
            ...
            <button className=" w-75 rounded-3 p-0 border-1 text-black" onClick={handleCalculateClick}>
              Calculate
            </button>
          </div>
        ) : (
          <div className="calculator-results mt-4 text-black">
            <div className='d-flex justify-content-between border-bottom mb-4'>
              <button className=" p-0 m-0 ms-1 " style={{ height: "25px" }} onClick={handleBackClick}>
                <img src="images/calculator/back.png" alt="" />
              </button>
